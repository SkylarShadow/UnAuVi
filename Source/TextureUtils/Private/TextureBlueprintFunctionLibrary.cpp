...
void UTextureBlueprintFunctionLibrary::SaveTextureToAsset(UTexture2D* InTexture)
{
	...
	// copy texture
	UTexture2D* NewTexture = CopyTexture2D(InTexture, NewPackage, FName(TextureName));
...
void UTextureBlueprintFunctionLibrary::CheckTexturesSizeInFolder(const FString& FolderPath)
{
	...
	for (int32 i = 0; i < Total; ++i)
	{
		...
		UE_LOG(LogTextureUtils, Log, TEXT("[%3.0f%%] check textures£º%s"), ProgressPercent, *TextureName);
